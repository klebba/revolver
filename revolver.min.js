...
function m(a,b){var c=window.hasOwnProperty("Modernizr")?window.hc:j;this.options=$.extend(h,{},{speed:1250,ib:"swing",mode:"fluid",h:c&&c.h,A:c&&c.jc,ca:c&&c.kc,dc:c&&c.lc,O:j,f:j,fa:j,W:h,Ub:0,C:{enabled:j,sb:j,pause:4E3,direction:"forward"},controls:{Xa:h,list:j,key:j},o:{Mb:k(),P:k(),B:k(),Va:k(),gc:k(),fc:k(),gb:k()},b:{H:"rev-mask",c:"rev-container",item:"rev-item",ua:"rev-clone",h:"rev-touch",fb:"rev-current",next:"rev-next",j:"rev-previous",focus:"rev-focus",Ya:"rev-before-focus",Wa:"rev-after-focus",
...
j}},disable:function(){this.isEnabled()&&(this.T()?(this.Nb(),this.c.stop(),this.state.v&&this.xb(),this.state.enabled=j,this.a.z(this.options.b.enabled)):this.state.enabled=j)}};this.Revolver=m;