...
f=d?b:e;return c===f?this.options.wraparound?d?e:b:f:c+a},toItemInternal:function(a,b){var c=this.items,c=$.isNumeric(a)?a:$.inArray(a,c);this.setCurrentItemIndex(c)&&this.syncPosition(b)},toPageInternal:function(a,b){var c=this.state,e=c.pages,c=c.currentItemIndex,a=this.forceValidPageIndex(a),e=e[a];e!==c&&this.toItemInternal(e,b)},nextInternal:function(){this.isFluid()?this.toNextItemInternal():this.toNextPageInternal()},previousInternal:function(){this.isFluid()?this.toPreviousItemInternal():
this.toPreviousPageInternal()},toNextItemInternal:function(){this.toItemInternal(this.getNextItemIndex())},toPreviousItemInternal:function(){this.toItemInternal(this.getPreviousItemIndex())},toNextPageInternal:function(){this.toPageInternal(this.getNextPageIndex())},toPreviousPageInternal:function(){this.toPageInternal(this.getPreviousPageIndex())},getNextPageIndex:function(){return this.getPageIndex(1)},getPreviousPageIndex:function(){return this.getPageIndex(-1)},getPageIndex:function(a){var b=
this.state,c=b.pages,e=c.length,d=b.currentItemIndex,b=Math.ceil(d/b.itemsPerPage),f=0<a,g=f?e-1:0;return d===c[g]?this.options.wraparound?f?0:e-1:g:b+1*a},elementIsValid:function(){var a=this.el,b=this.options,c=$("."+b.classNames.container,a),b=$("."+b.classNames.item,c);"undefined"===typeof this.validElement&&(this.validElement=a&&a.length&&c&&c.length&&b&&1<b.length);return this.validElement},isFluid:function(){return"fluid"===this.options.mode},isFixed:function(){return"fixed"===this.options.mode},
isLocked:function(){return this.state.busy},isEnabled:function(){return this.state.enabled},isCycling:function(){return this.state.cycling},next:function(){this.resetCycle();this.nextInternal()},previous:function(){this.resetCycle();this.previousInternal()},toItem:function(a,b){this.resetCycle();this.toItemInternal(a,b)},toPage:function(a,b){this.resetCycle();this.toPageInternal(a,b)},toNextItem:function(){this.resetCycle();this.toNextItemInternal()},toPreviousItem:function(){this.resetCycle();this.toPreviousItemInternal()},
toNextPage:function(){this.resetCycle();this.toNextPageInternal()},toPreviousPage:function(){this.resetCycle();this.toPreviousPageInternal()},addItems:function(a,b){b?this.container.prepend(a):this.container.append(a);this.cacheItems();this.resize()},enable:function(){if(!this.isEnabled()){var a=this.options;this.elementIsValid()?(this.addControls(),a.automatic.enabled&&this.initCycle(),this.el.addClass(a.classNames.enabled),this.state.enabled=!0):this.state.enabled=!1}},disable:function(){this.isEnabled()&&
